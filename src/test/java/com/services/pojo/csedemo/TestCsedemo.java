...
public class TestCsedemo {
    ...
    public void testsayHi(){
        ...
        String expactReturnValue = "Hi, GuveXie! Welcome to servicestage."; // You should put the expect String type value here.

        // You should put the parameter here, in such footprint: csedemoImpl.sayHi(String name)
        String returnValue = csedemoImpl.sayHi("GuveXie");
